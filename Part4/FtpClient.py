...
# Define maximum bandwidth limit (e.g., 100 KB/s)
    ...
    def send_data(self, file_name):
        ...
        with open(file_name, 'rb') as file:
            ...
            while True:
                ...
                self.clientDataSock.sendall(data)
                ...
                if not data:
                    break
            self.clientDataSock.sendall(b'\x00' * CHUNK_SIZE)
    ...
    def get_data(self, file_name):
        with open(file_name, 'wb') as file:
            while True:
                ...
                data = self.clientDataSock.recv(CHUNK_SIZE)
